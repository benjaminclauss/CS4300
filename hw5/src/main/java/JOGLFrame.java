...
public class JOGLFrame extends JFrame {
  ...
  private static final String DRONE_SCENEGRAPH = "scenegraphmodels/drone/drone.xml";
  ...
  public JOGLFrame(String title, String scenegraphModel, Vector3f globalCameraPosition, Vector3f globalCameraLookAt, Vector3f globalCameraUp) {
    ...
    canvas.addGLEventListener(new GLEventListener() {
      ...
      public void init(GLAutoDrawable glAutoDrawable) {
        try {
          // Initialize view of input configuration and drone.
          ...
          InputStream axesInputStream = getClass().getClassLoader().getResourceAsStream(DRONE_SCENEGRAPH);
          view.initializeDrone(glAutoDrawable, axesInputStream);
