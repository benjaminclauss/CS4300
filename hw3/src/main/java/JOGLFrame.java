...
public class JOGLFrame extends JFrame {
  ...
  public JOGLFrame(String title, String scenegraphModel, Vector3f cameraPosition, Vector3f cameraLookAt, Vector3f cameraUp) {
    ...
    view = new View(cameraPosition, cameraLookAt, cameraUp);
    ...
    canvas.addGLEventListener(new GLEventListener() {
      ...
      public void init(GLAutoDrawable glAutoDrawable) { //called the first time this canvas is created. Do your initialization here
        try {
          ...
          InputStream in = getClass().getClassLoader().getResourceAsStream("scenegraphmodels/" + scenegraphModel);
