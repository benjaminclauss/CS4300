    ...
    canvas.addGLEventListener(new GLEventListener() {
      ...
      public void init(GLAutoDrawable glAutoDrawable) {
        try {
          ...
          InputStream axesInputStream = getClass().getClassLoader().getResourceAsStream("scenegraphmodels/arrows/axes.xml");
          view.initializeAxes(glAutoDrawable, axesInputStream);
