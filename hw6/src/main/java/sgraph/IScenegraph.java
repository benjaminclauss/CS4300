...
public interface IScenegraph<VertexType extends IVertexData>
{
    ...
    /**
     * Animate scene graph nodes with name with provided transformations.
     * @param animationTransformations map of node names to transformations
     */
    void animate(Map<String, Matrix4f> animationTransformations);
    ...
    /**
     * Descends the scene graph, converts all the lights into the view coordinate system and returns them in a list.
     * @param modelView the stack of modelview matrices
     * @return the lights of the scene graph
     */
    List<Light> getLights(Stack<Matrix4f> modelView);
