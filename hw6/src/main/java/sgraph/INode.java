...
public interface INode
{
    ...
    /**
     * Returns the lights for this node transformed using the provided modelview.
     * @param modelView the stack of modelview matrices
     * @return the lights of the node
     */
    List<Light> getLightsForNode(Stack<Matrix4f> modelView);

    /**
     * Returns the lights for this node and children transformed using the provided modelview.
     * @param modelView the stack of modelview matrices
     * @return the lights of the node and children
     */
    List<Light> getLightsForNodeAndChildren(Stack<Matrix4f> modelView);
}
